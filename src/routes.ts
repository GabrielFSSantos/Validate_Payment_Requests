...
api.delete('/creditors/delete/:id', CreditorController.delete);
...
api.delete('/debtors/delete/:id', DebtorController.delete);
...
api.delete('/payments/delete/:id', PaymentController.delete);
